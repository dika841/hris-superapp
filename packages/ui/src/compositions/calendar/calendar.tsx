...
export function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn('p-3 bg-card rounded-2xl border border-border shadow-md inline-block', className)}
      classNames={{
        ...
        button_previous: cn(
          ...
          'h-7 w-7 bg-transparent p-0 opacity-60 hover:opacity-100 absolute left-1 cursor-pointer'
        ),
        button_next: cn(
          buttonVariants({ variant: 'outline' }),
          'h-7 w-7 bg-transparent p-0 opacity-60 hover:opacity-100 absolute right-1 cursor-pointer'
        ),
        ...
        day_button: cn(
          ...
          'h-8 w-8 p-0 font-normal aria-selected:opacity-100 rounded-lg cursor-pointer'
        ),
